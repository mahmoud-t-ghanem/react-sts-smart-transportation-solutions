  ...
  return (
    ...
    >
      <Container maxWidth="xl">
        ...
        >
          ...
          >
            ...
            <Button
              ...
              sx={{
                color: menuOpen ? "secondary.main" : theme.palette.text.primary,
                fontWeight: 600,
                fontSize: "1.1rem",
                textTransform: "none",
                position: "relative",
          ...
          {/* زر الموبايل - تم تعديل الـ transition لمنع الارتجاج */}
          <Box sx={{ display: { xs: "block", md: "none" } }}>
            <IconButton
              ...
              sx={{
                ...
                transition: "transform 0.3s ease-in-out", // حركة ناعمة ومتناسقة مع الـ Collapse
              }}
            >
              {mobileMenuOpen ? (
        ...
        {/* القائمة المنسدلة للموبايل - تم عزل الـ Padding والـ Border لضمان انسيابية الحركة */}
        <Collapse in={mobileMenuOpen} timeout="auto">
          <Box
            sx={{
              ...
              overflow: "hidden", // يمنع خروج العناصر أثناء الحساب الديناميكي للارتفاع
            }}
          >
            {/* زر Home */}
            <Button
