...
const OtrRegionalDryVanService = () => {
  ...
  return (
    ...
    >
      {/* أيقونة الخلفية المائية الفخمة المعبرة عن الطرق الطويلة والمسارات الإقليمية */}
      <RouteIcon
        sx={{
          position: "absolute",
          bottom: "-20px",
      ...
      <Container maxWidth="xl" sx={{ position: "relative", zIndex: 2 }}>
        ...
        >
          ...
          >
            ...
            {/* الوصف التفصيلي المستخرج بدقة من صورة image_c676c6.png */}
            <Typography
              variant="body1"
              sx={{
            ...
            >
              ...
              built on reliability and precision. Our professional drivers and
              24/7 dispatch team ensure{" "}
              <Box
                component="span"
                sx={{ color: theme.palette.text.primary, fontWeight: 700 }}
              >
              ...
              with real-time tracking and proactive communication every mile.
            </Typography>
            ...
            >
              ...
              >
                Reliable delivery. Predictable <br />
                performance.
              </Typography>
            </Box>
          </Box>

          {/* 2. قسم الصورة العائمة مع التوهج والأقواس المنضبطة بنسبة 100% */}
          <Box
            sx={{
              position: "relative",
              width: { xs: "100%", md: "50%" },
          ...
          >
            ...
            >
              <Box
                component="img"
                src="https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?auto=format&fit=crop&q=80&w=1200&fm=webp"
...
export default OtrRegionalDryVanService;
